...
<html lang="pt">
    <head>
        <title> LegacyTech | Sobre a empresa - Missão, visão e valores </title>
        <meta charset="utf-8">
        <link rel="stylesheet" type="text/css" href="../../css/geral.css">
        <link rel="stylesheet" type="text/css" href="../../css/index.css">
        <link rel="stylesheet" type="text/css" href="../../css/mvv.css">
...
<!--            Visão.    -->
                <div class="faixa_alternativa">
                    <div class="segura_conteudo_no_meio">
                        <section class="texto_na_direita">
                            <h2>Visão</h2>
                            <p>
